    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if(ModInstances.nickHider.isEnabled() && s1.contains(mc.getSession().getUsername())){
                    s1 = s1.replaceAll(mc.getSession().getUsername(), EnumChatFormatting.GOLD + ModInstances.nickHider.getPlayerName());
                }
