...
import whirlwind.ui.util.CustomButton;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected List<CustomButton> customButtonList = Lists.<CustomButton>newArrayList();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            ((CustomButton)this.customButtonList.get(i)).drawButton(this.mc, mouseX, mouseY);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ...
            for (int i = 0; i < this.customButtonList.size(); ++i)
            {
                CustomButton guibutton = (CustomButton)this.customButtonList.get(i);
